...
const cacheService = new CacheService<TickerData>(30000); // caching mechanism removed from TickerService because of deployment issues
const tickerService = new TickerService(cacheService, 'ticker-cache');
